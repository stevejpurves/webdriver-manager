...
var versions =  { "selenium": "2.42.2", "chromedriver": "2.10", "iedriver": "2.42.0" };
...
WebdriverManager.prototype.start = function (seleniumPort, extendedTimeout) {
  ...
  if (extendedTimeout) {
    args.push('-timeout', 45000);
    args.push('browserTimeout', 60000);
  }
